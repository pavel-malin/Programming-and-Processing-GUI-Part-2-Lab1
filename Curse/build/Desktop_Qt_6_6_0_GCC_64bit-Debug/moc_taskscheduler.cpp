...
struct qt_meta_stringdata_CLASSTaskSchedulerENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSTaskSchedulerENDCLASS = QtMocHelpers::stringData(
    "TaskScheduler",
    "addTask",
    "",
    "deleteTask",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTaskSchedulerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTaskSchedulerENDCLASS_t qt_meta_stringdata_CLASSTaskSchedulerENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTaskSchedulerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TaskScheduler::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTaskSchedulerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTaskSchedulerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTaskSchedulerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TaskScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTaskSchedulerENDCLASS.stringdata0))
